...
export default function ResourcesMenu({ onClose, onMouseEnter, onMouseLeave }: ResourcesMenuProps) {
  const learnItems = [
  ...
  return (
    ...
    >
      {/* Pointer Arrow pointing to Resources link */}
      <div className="absolute -top-2 left-[52%] w-4 h-4 bg-white border-t border-l border-gray-200 rotate-45" />

      {/* Left 8 Columns: Learn Items */}
      ...
      <div className="col-span-4 bg-gray-50/80 rounded-xl border border-gray-200/60 p-4 flex flex-col justify-between">
        ...
        >
          Go to Blog <ArrowUpRight className="w-3.5 h-3.5" />
        </Link>
      </div>
